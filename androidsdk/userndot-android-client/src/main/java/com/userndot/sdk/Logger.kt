...
class Logger {
    ...
    private  var debugLevel: UserNDot.LogLevel

    private constructor(debugLevel: UserNDot.LogLevel = UserNDot.LogLevel.OFF) {
        this.debugLevel = debugLevel
    }

    companion object {

        fun getInstance(debugLevel: UserNDot.LogLevel = UserNDot.LogLevel.OFF): Logger {
            return Logger(debugLevel)
        }

        private fun getStaticDebugLevel(): Int {
            return UserNDot.debugLevel.intValue
        }
        ...
        fun d(message: String) {
            if (getStaticDebugLevel() > UserNDot.LogLevel.INFO.intValue) {
        ...
        fun v(message: String) {
            if (getStaticDebugLevel() > UserNDot.LogLevel.DEBUG.intValue) {
