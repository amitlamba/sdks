...
//                //it give a collapse message view
...
//                        .setBigContentTitle("Image title")
//                        .setSummaryText("image")
//                        .bigLargeIcon(null))
//                //inbox style
...
//                //to set sound
////                .setSound(Uri.parse("path of ringtone"))
//                //add action if any
////                .addAction(NotificationCompat.getAction(icon,label,actionintent))
